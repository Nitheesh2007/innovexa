    ...
    <div className="flex flex-col h-full w-full">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <button type="button" className="text-sm font-semibold text-primary hover:text-primary-600 transition-colors">Forgot password?</button>
        </div>
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-white dark:bg-gray-800 text-gray-500 rounded-full border border-gray-200 dark:border-gray-700 shadow-sm z-10">Or continue with</span>
          </div>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
          Don't have an account? <Link to="/register" className="text-primary hover:text-primary-600 font-semibold transition-colors">Register here</Link>
        </p>
        <div className="flex justify-center mt-6">
          <Link to="/admin-login" className="px-4 py-2 bg-amber-50 dark:bg-amber-900/20 text-amber-600 dark:text-amber-500 hover:bg-amber-100 dark:hover:bg-amber-900/40 rounded-xl text-xs font-bold uppercase tracking-wider flex items-center gap-1.5 transition-colors">
